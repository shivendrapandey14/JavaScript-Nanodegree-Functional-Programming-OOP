...
async function handleCreateRace() {
	try{
		...
		if (!player || !track) {
			alert(
				"You can not proceed with the race. Please select both the racer and the track before starting the race!"
			);
			return;
		}
...
async function getTracks() {
	...
	try {
		...
		console.log("Error in getTracks request: ", err);
	}
}
...
async function getRacers() {
	...
	try {
		...
		console.log("Error occurred in getRacers: ", err );
	}
}
